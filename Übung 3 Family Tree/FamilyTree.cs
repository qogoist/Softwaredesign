...
namespace Debugging
{
    ...
    public class Familytree
    {
        public static Person Find(Person person)
        {
            ...
            var difference = today.Year - person.DateOfBirth.Year;
                ...
                new Person
                {
                    ...
                    Mom = new Person
                    {
                        ...
                        Mom = new Person
                        {
                            ...
                            DateOfDeath = new DateTime(2009, 02, 03),
                            Mom = new Person { FirstName = "Ruth", LastName = "Gill", DateOfBirth = new DateTime(1908, 06, 07), DateOfDeath = new DateTime(1988, 05, 23) },
                            Dad = new Person { FirstName = "Moritz", LastName = "Roche", DateOfBirth = new DateTime(1885, 07, 08), DateOfDeath = new DateTime(1976, 07, 26) }
                        },
                        Dad = new Person
                        {
                            FirstName = "Eddie",
                            ...
                            DateOfDeath = new DateTime(1998, 09, 12),
                            Mom = new Person { FirstName = "Cynthia", LastName = "Hamilton", DateOfBirth = new DateTime(1897, 08, 16), DateOfDeath = new DateTime(1962, 01, 05) },
                            Dad = new Person { FirstName = "Albert", LastName = "Spencer", DateOfBirth = new DateTime(1892, 05, 23), DateOfDeath = new DateTime(1963, 01, 07) }
                        },
                    },
                    Dad = new Person
                    {
